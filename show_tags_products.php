...
$sql  = "SELECT `SR_NO`,`NAME` , `PRICE`, `IMAGE`,  `DISCRIPTION` FROM products WHERE `TAGS`=' $tag_id' LIMIT {$offset}, {$limit} ";
              ...
              <nav>
                ...
                <?php
                   ...
                   if ($result1->num_rows > 0) { 
                       ...
                       if ($page>1) {
                           echo '  <li>
                               <a href="show_tags_products.php?page='.($page-1).'&tag_id='.$tag_id.'" aria-label="Previous">
                               <span aria-hidden="true">&laquo;</span>
                               </a>
                               </li>';
                       }
                       for ($i=1; $i<=$total_page; $i++) {
                               echo '<li><a href="show_tags_products.php?page='.$i.'&tag_id='.$tag_id.'">'.$i.'</a></li>';
                       }
                       if ($total_page > $page) {
                           echo '<li>
                                   <a href="show_tags_products.php?page='.($page+1).'&tag_id='.$tag_id.'" aria-label="Next">
