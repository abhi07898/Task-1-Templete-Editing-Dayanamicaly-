    ...
    <div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
                ...
                <a href="#" class="nav-top-item <?php if (in_array($filename, $productmenu)) : ?> current <?php endif; ?>"> 
					...
					<ul>
                        <li><a href="products.php" <?php if ($filename === 'products.php') : ?> class = "current" <?php endif; ?> >Manage Product</a></li>
						<li><a  href="categories.php" <?php if ($filename === 'categories.php') : ?> class = "current" <?php endif; ?> >Manage Categories</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a href="tags.php" <?php if ($filename === 'tags.php') : ?> class = "current" <?php endif; ?>>Manage Tags </a></li>
							<li><a href="colors.php" <?php if ($filename === 'colors.php') : ?> class = "current" <?php endif; ?>>Manage Colors </a></li>
				...
				<li>
					...
					<ul>
						<li><a href="users.php" class = "current" >Add Users</a></li>
